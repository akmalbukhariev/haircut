...
class _ChooseServicePage extends State<ChooseServicePage> {
  ...
  Future<void> _askedToLead() async {
        ...
        builder: (BuildContext context) {
          return SimpleDialog(
            ...
            children: <Widget>[
              SimpleDialogOption(
                onPressed: () {
                  Navigator.pop(context, Department.Uzbek);
                },
                child: const Text("O'zbek"),
              ),
              SimpleDialogOption(
                onPressed: () {
                  Navigator.pop(context, Department.Russian);
                },
                child: const Text("Ruski"),
              ),
              SimpleDialogOption(
                onPressed: () {
                  Navigator.pop(context, Department.English);
                },
    ...
    {
      case Department.Uzbek:
        print("clicked uzbek");
        break;
      case Department.Russian:
